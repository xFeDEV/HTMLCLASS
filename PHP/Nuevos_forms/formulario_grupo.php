            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <p>Llena todos los campos para registrar grupo</p>
                        <form class="requires-validation" action="ingresar_grupo.php" method="POST" novalidate>

                            <div class="col-md-12">
                               <input class="form-control" type="text" name="nombre_grupo" placeholder="Nombre del grupo" required>
                               <div class="valid-feedback">Datos correctas!</div>
                               <div class="invalid-feedback">Este dato es necesisario para el registrar grupo</div>
                            </div>

                            <div class="col-md-12 mt-3">
                                <input class="form-control" type="number" name="ano_escolar" placeholder="Año escolar" required>
                                <div class="valid-feedback">Datos correctas!</div>
                                <div class="invalid-feedback">Este dato es necesisario para el registrar grupo</div>
                            </div>
                           ...
                           <div class="col-md-12">
                              <input class="form-control" type="text" name="jefe_grupo" placeholder="Jefe de grupo" required>
                              <div class="valid-feedback">Datos correctas!</div>
                              <div class="invalid-feedback">Este dato es necesisario para el registrar grupo</div>
                           </div>
