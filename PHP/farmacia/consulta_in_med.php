...
<head>
    ...
    <title>Consulta individual medicamento</title>
</head>
<body>
    <?php
    ...
    <div class="container text-center text-light mt-5">
        <div class="row">
            <div class="col-12 mb-2">
                <h1>Consulta indivual medicamento</h1>
            </div>
        ...
        <div class="container">
            <?php
                    if(isset($_POST['nombre'])){
                        ...
                        if ($_POST['nombre'] != "Seleccione medicamento"){
                            echo '<h3 class="m-3"> RESULTADOS </h3>';
                        
                        $consulta = $conexion->query("SELECT * from medicamentos where nombre='$nombre' ");
                        ...
                        foreach ($fields as $key => $label) {
                            ...
                            echo "SELECCIONE UN MEDICAMENTO PARA CONSULTAR";
                        }
                        }
